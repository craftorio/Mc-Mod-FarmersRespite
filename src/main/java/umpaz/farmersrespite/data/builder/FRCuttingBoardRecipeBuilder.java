...
public class FRCuttingBoardRecipeBuilder {
   ...
   public void build(Consumer<FinishedRecipe> consumerIn) {
      ...
      this.build(consumerIn, "farmersrespite:cutting/" + location.getPath());
   }
   ...
   public void build(Consumer<FinishedRecipe> consumerIn, ResourceLocation id) {
      consumerIn.accept(
         new FRCuttingBoardRecipeBuilder.Result(id, this.ingredient, this.tool, this.results, this.soundEventID == null ? "" : this.soundEventID)
      );
   }
