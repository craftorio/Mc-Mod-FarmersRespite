...
public class FRCookingRecipes {
    ...
    private static void cookMiscellaneous(Consumer<FinishedRecipe> consumer) {
        FRCookingPotRecipeBuilder.cookingPotRecipe(FRItems.BLAZING_CHILI.get(), 1, 200, 0.35F)
                ...
                .build(consumer);
        FRCookingPotRecipeBuilder.cookingPotRecipe(FRItems.TEA_CURRY.get(), 1, 200, 0.35F)
